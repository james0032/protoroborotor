...
df = pl.scan_parquet("gs://mtrx-us-central1-hub-dev-storage/kedro/data/tests/emb_replace_robokop_cgd_no_tmkp/datasets/embeddings/feat/nodes_with_embeddings/")
